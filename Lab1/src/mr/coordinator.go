...
func (m *Coordinator) GetWorkerTask(args *GetTaskArgs, reply *GetTaskReply) error {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *Coordinator) checkIfAllMapTasksAreDone() bool {
...
func (m *Coordinator) checkIfAllReduceTasksAreDone() bool {
...
func (m *Coordinator) ReportOnMap(args *ReportOnMapToCoordinatorArgs, reply *ReportOnMapToCoordinatorReply) error {
	...
	if args.Status == 2 {
		// fmt.Println("Updating the stage of map task of Coordinator")
...
func (m *Coordinator) ReportOnReduce(args *ReportOnMapToCoordinatorArgs, reply *ReportOnMapToCoordinatorReply) error {
...
func TenSecondsCheckMap(taskId int, m *Coordinator) {
...
func TenSecondsCheckReduce(taskId int, m *Coordinator) {
...
func MakeCoordinator(files []string, nReduce int) *Coordinator {
	...
	// fmt.Printf("Maptask stored in Coordinator : %+v\n", m.mapTasks[0])
